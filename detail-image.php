...
<head>
    ...
    <style>
        ...
        @media screen and (max-width: 768px) {
            ...
            /* Ubah Wrapper jadi Kolom (Atas-Bawah) */
            .insta-post-wrapper {
                display: flex;
                flex-direction: column; 
                height: auto; 
            ...
            /* Sembunyikan border wrapper di HP */
            .content-wrapper {
                max-width: 100%;
            }
            .detail-container-outer {
                padding: 20px 15px; /* Padding halaman di HP */
            }
        }

        /* Komponen Tambahan aja */
        ...
        .comment-section { display: flex; align-items: center; margin-top: 10px; }
        .comment-section input { flex: 1; border: none; outline: none; background: transparent; }
        .caption-box { display: flex; gap: 10px; margin-bottom: 10px; }
                ...
                <div class="post-right">
                        ...
                        <div class="caption-box">
                             <div style="display: flex; gap: 10px;">
                                ...
                                <div>
                                    ...
                                    <br><span class="time-ago"><?php echo $p->date_created ?></span>
                                </div>
                             </div>
                        </div>
                        
                        <div class="caption-box" style="opacity: 0.7;">
                            <div class="small-avatar" style="background: #ccc; flex-shrink: 0;"></div>
                            <div>
                                <span class="username-text">dummy</span>
                                <span class="caption-text">GACORRR! 🔥</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="right-footer">
                        ...
                        <div class="comment-section">
                            ...
                            <button style="background:none; border:none; color:#0095f6; font-weight:bold; cursor:pointer;">Post</button>
                        </div>
                    </div>
